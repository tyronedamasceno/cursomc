...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "joao@gmail.com", "36378912377", TipoCliente.PESSOA_FISICA, encoder.encode("batata"));
		
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Ana Costa", "tyronedamasceno@gmail.com", "31628382740", TipoCliente.PESSOA_FISICA, encoder.encode("batata"));
