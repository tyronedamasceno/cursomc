package com.tyrone.cursomc.services.validation.utils;

/**
 * 
 * fonte: https://github.com/acenelio/springboot2-ionic-backend/blob/master/src/main/java/com/nelioalves/cursomc/services/validation/utils/BR.java
 * @author adrianoluis
 *
 */
